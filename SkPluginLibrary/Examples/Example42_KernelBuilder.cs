...
public static class Example42_KernelBuilder
{
    public static Task RunAsync()
    {
        ...
        string azureOpenAIChatDeploymentName = TestConfiguration.AzureOpenAI.Gpt4DeploymentName;
        string azureOpenAIChatModelId = TestConfiguration.AzureOpenAI.Gpt35ModelId;

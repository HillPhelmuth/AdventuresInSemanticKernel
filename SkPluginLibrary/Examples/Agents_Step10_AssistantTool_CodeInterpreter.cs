...
/// </summary>
public static class Agents_Step10_AssistantTool_CodeInterpreter
{
    
    public static async Task UseCodeInterpreterToolWithAssistantAgentAsync()
    {
        // Define the agent
        ...
        var assistant = await assistantClient.CreateAssistantAsync(TestConfiguration.OpenAI.Gpt4MiniModelId,
            new AssistantCreationOptions() { Tools = { ToolDefinition.CreateCodeInterpreter() } });

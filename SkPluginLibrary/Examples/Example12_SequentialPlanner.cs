...
internal static class Example12_SequentialPlanner
{
    ...
    private static IKernel InitializeKernel()
    {
        ...
        var kernel = new KernelBuilder()
            .WithLoggerFactory(ConsoleLogger.LoggerFactory)
            .WithOpenAIChatCompletionService(TestConfiguration.OpenAI.ModelId, TestConfiguration.OpenAI.ApiKey, alsoAsTextCompletion: true)
            .WithOpenAITextEmbeddingGenerationService(TestConfiguration.OpenAI.EmbeddingModelId, TestConfiguration.AzureOpenAIEmbeddings.ApiKey)
            .Build();
    ...
    private static SemanticTextMemory InitializeMemory()
    {
        ...
        var textEmbeddingGenerator = new OpenAITextEmbeddingGeneration(

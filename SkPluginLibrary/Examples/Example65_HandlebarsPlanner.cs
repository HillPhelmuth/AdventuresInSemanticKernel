...
public static class Example65_HandlebarsPlanner
{
    ...
    private static async Task RunSampleAsync(string goal, params string[] pluginDirectoryNames)
    {
        ...
        var kernel = new KernelBuilder()
            .WithLoggerFactory(ConsoleLogger.LoggerFactory).WithOpenAIChatCompletionService(TestConfiguration.OpenAI.ModelId, TestConfiguration.OpenAI.ApiKey, alsoAsTextCompletion:true, serviceId:"OpenAIChat")
            .Build();
        ...
        var allowLoopsInPlan = !TestConfiguration.OpenAI.ModelId.Contains("gpt-3.5-turbo", StringComparison.OrdinalIgnoreCase);

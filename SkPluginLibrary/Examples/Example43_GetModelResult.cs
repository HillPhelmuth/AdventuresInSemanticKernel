...
#pragma warning restore CA1031 // Do not catch general exception types
        ...
        string OutputExceptionDetail(Exception? exception)
        {
            ...
            {
                HttpOperationException httpException => new { StatusCode = httpException.StatusCode?.ToString(), httpException.Message, Response = httpException.ResponseContent }.AsJson(),
                { } e => e.Message,
                _ => string.Empty
            };
        }

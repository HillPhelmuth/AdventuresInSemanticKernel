...
public class AutoSequentialChat
{
    private readonly ChatContext _chatContext;
    private List<ChatAgent> _agents = [];
    private readonly Kernel _kernel;
    public AutoSequentialChat(List<AgentProxy> agents, ChatContext chatContext, Kernel kernel)
    {
    ...
    public async IAsyncEnumerable<string> ExecuteChat(string input, [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        while (true)
        {
            ...
            var appendToSysPrompt = $"""
                                    ...
                                    """;
            var chatHistory = new ChatHistory(nextAgent.SystemPromptOverride(appendToSysPrompt));
